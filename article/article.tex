...
The purpose of this part of the study is to ask whether KNIME-matching papers
preserve the evidence needed to open and reproduce a KNIME-based workflow:
full text, KNIME-use role, version information, workflow files, workflow
figures or textual descriptions, data, code, and extension context. The
statistics in this subsection use the 100-record structured audit registry.
